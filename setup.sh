...
python2 -m pip install python-vlc pyttsx3
...
tar -xf pine64-debian-jessie-1.1.1.tar.bz2
tar -xf edison-ubilinux-1.1.1.tar.bz2

mv ubuntu1404-x86_64-1.1.1 snowboy
mv rpi-arm-raspbian-8.0-1.1.1 snowboy
mv pine64-debian-jessie-1.1.1 snowboy
mv edison-ubilinux-1.1.1 snowboy
